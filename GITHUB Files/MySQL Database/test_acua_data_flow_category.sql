...
CREATE TABLE `flow_category` (
  `Flow_Orientation` varchar(5) NOT NULL,
  `Flow_Numerical_Category` int NOT NULL,
  PRIMARY KEY (`Flow_Orientation`),
  KEY `Numerical_Category_index` (`Flow_Numerical_Category`)
...
INSERT INTO `flow_category` VALUES ('G',1),('F',5);
...
-- Dump completed on 2022-06-03 15:19:35
